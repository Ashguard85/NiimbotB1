...
- Vorlagen und Verlauf lokal in IndexedDB oder optional über den Docker-v16-Server-Provider.
...
- **Server:** HTTPS-API zu Docker v16; Druck bleibt trotzdem lokal Endgerät → Bluetooth → B1.
...
## Update-Lifecycle
Service-Worker-Cache: `qr-label-pwa-v16`. Neue Versionen werden vorbereitet und nicht mitten in laufenden Aktionen erzwungen. Kein unkontrollierter `controllerchange`-Reload-Loop.
