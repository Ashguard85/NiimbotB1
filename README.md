# QR Label v43
## v43 – Auswahl nach Rotation korrigiert

Rotierte Auswahl- und Touchboxen werden jetzt um denselben Mittelpunkt wie das Element berechnet. 90°/270° tauschen Breite und Höhe ohne Versatz. Ein konsistenter 2,5-%-Innenrand verhindert unbeabsichtigtes Abschneiden. Die Auswahl lässt sich per „Auswahl aufheben“, erneutem Klick auf den aktiven Elementbutton oder Tap auf freie Vorschaufläche entfernen; danach verschwinden Rahmen und Resize-Handle.

## v43 – Bedienung des Designers verfeinert
...
## v43 – Tablet-first Label Designer

v43 ist der größere UI-Sprung: Die Vorschau steht jetzt im Mittelpunkt und der Label-Designer liegt **zwingend direkt darunter**. Inhalt, Renderer und Druckoptionen sind in einklappbare Bereiche gegliedert, damit die Oberfläche auf Tablets schlank bleibt.
...
## v43 – visueller Label-Designer

v43 ergänzt einen lokalen Designer direkt in der Labelvorschau. Es gibt bewusst **noch kein Layout-Preset-System** und keinen `layout=`-URL-Parameter.
...
## v43 – Subcaption / zweite Textzeile

Zusätzlich zur bestehenden `caption` unterstützt v43 eine zweite, kleinere Zeile **`subcaption`**, z. B. für eine Raumbezeichnung.
...
## v43 – steuerbarer QR-Ruheraum im lokalen Renderer
...
v43 macht diesen Wert sichtbar und steuerbar:
