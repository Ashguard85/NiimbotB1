...
## v41 – lokaler QR-Ruheraum

Nur für **Offline (lokal)**:

- `quiet=4` – Standard
- `quiet=2` – kompakter
- `quiet=0` – kein interner QR-Ruheraum; nur für kontrollierte Tests

Aliase: `qrspace=` und `quietzone=`.
...
Der visuelle Designer ist lokal pro Labelgröße gespeichert. URL-Parameter für Designerpositionen oder benannte Layouts gibt es in v41 bewusst noch nicht. URL-Inhalte (`url`, `caption`, `subcaption`, `quiet` usw.) werden weiterhin in das lokal gespeicherte Designer-Layout eingesetzt.
