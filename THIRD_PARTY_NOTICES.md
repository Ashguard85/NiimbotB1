...
License: MIT  
Pinned runtime version in v6: `2.4.0`
...
License: MIT  
Pinned runtime version in v6: `1.4.4`

The library generates QR matrices in the browser.

## Runtime hosting note

v6 loads both pinned libraries from `unpkg.com`. The service worker caches them opportunistically after a successful online load, so they can be reused offline if the browser permits caching opaque cross-origin script responses.
