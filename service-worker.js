"use strict";
const CACHE_VERSION = "qr-label-pwa-v7";
const CACHE = CACHE_VERSION;
const APP_SHELL = [
  "./","./index.html","./app.css?v=7","./app.js?v=7","./storage.js?v=7","./providers.js?v=7","./printer.js?v=7",
  "./manifest.webmanifest?v=7","./offline.html",
